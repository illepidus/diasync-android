...
> [!WARNING]  
> **⚠️ Внимание: Приложение находится в активной разработке ⚠️**  
> На данный момент Diasync for Android еще не работает, но я активно его разрабатываю. Следите за обновлениями!
